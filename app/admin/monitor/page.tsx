                    ...
                    <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors">
                      ...
                      <td className="p-4 text-center space-y-2">
                        ...
                        {p.folio_factura ? (
                          ...
                          <button onClick={() => setFacturaModal({ open: true, pedido: p, folio: p.folio_factura || '' })} className="w-full px-2 py-1 bg-white dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded text-[10px] transition-colors">Solicitar Factura</button>
                        )}
                      </td>
                    </tr>
                  ))}
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select className="w-full mt-1 bg-white dark:bg-gray-950 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white p-2 rounded-lg text-sm" onChange={e => setNuevoPedido({ ...nuevoPedido, entregado_por: e.target.value })}>
        ...
        {facturaModal.open && (
          <div className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-2xl w-full max-w-sm shadow-2xl">
              <h3 className="text-lg font-bold mb-4 flex items-center gap-2 text-gray-900 dark:text-white"><FileText size={20} className="text-blue-500" /> Solicitar Factura</h3>
              <input type="text" placeholder="Ej. SAT-82931" value={facturaModal.folio} className="w-full bg-gray-50 dark:bg-gray-950 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white p-2 rounded-lg text-sm uppercase" onChange={e => setFacturaModal({ ...facturaModal, folio: e.target.value })} />
              <div className="flex gap-3 pt-6 mt-4 border-t border-gray-200 dark:border-gray-800">
                <button onClick={() => setFacturaModal({ ...facturaModal, open: false })} className="flex-1 py-2 font-semibold border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Cancelar</button>
