...
export default function AdminMonitor() {
  ...
  const guardarClienteFiscal = async () => {
    if (!nuevoCliente.nombre_local || !nuevoCliente.rfc) return alert('Nombre y RFC son obligatorios');
  ...
  const modificarClienteFiscal = async () => {
    ...
    const { error } = await supabase.from('clientes').update({
      ...
      uso_cfdi: c.uso_cfdi, email_facturacion: c.email_facturacion
    }).eq('id', c.id);
          ...
          <div className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-6 rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto text-gray-900 dark:text-gray-100">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="Ej. Sakura Ramen" value={nuevoCliente.nombre_local} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2 rounded-lg text-sm text-gray-900 dark:text-white" onChange={e => setNuevoCliente({...nuevoCliente, nombre_local: e.target.value})} />
                  </div>
                  <div>
                    <label className="text-xs font-semibold text-gray-500 dark:text-gray-400">RFC (Obligatorio)</label>
                    <input type="text" placeholder="Ej. XAXX010101000" value={nuevoCliente.rfc} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2 rounded-lg text-sm text-gray-900 dark:text-white uppercase" onChange={e => setNuevoCliente({...nuevoCliente, rfc: e.target.value})} />
                  </div>
                </div>
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="Ej. 77710" value={nuevoCliente.codigo_postal} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2 rounded-lg text-sm text-gray-900 dark:text-white" onChange={e => setNuevoCliente({...nuevoCliente, codigo_postal: e.target.value})} />
                  </div>
                  <div>
                    <label className="text-xs font-semibold text-gray-500 dark:text-gray-400">Email Envío Facturas</label>
                    <input type="email" placeholder="correo@cliente.com" value={nuevoCliente.email_facturacion} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2 rounded-lg text-sm text-gray-900 dark:text-white" onChange={e => setNuevoCliente({...nuevoCliente, email_facturacion: e.target.value})} />
                  </div>
                </div>
                <div>
                  <label className="text-xs font-semibold text-gray-500 dark:text-gray-400">Régimen Fiscal</label>
                  <select value={nuevoCliente.regimen_fiscal} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2.5 rounded-lg text-sm text-gray-900 dark:text-white" onChange={e => setNuevoCliente({...nuevoCliente, regimen_fiscal: e.target.value})}>
                ...
                <div>
                  ...
                  <select value={nuevoCliente.uso_cfdi} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2.5 rounded-lg text-sm text-gray-900 dark:text-white" onChange={e => setNuevoCliente({...nuevoCliente, uso_cfdi: e.target.value})}>
              ...
              <div className="flex gap-3 pt-6 mt-6 border-t border-gray-200 dark:border-gray-800">
                <button onClick={() => setIsClienteModalOpen(false)} className="flex-1 py-2.5 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Cancelar</button>
                <button onClick={guardarClienteFiscal} className="flex-1 py-2.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2"><Save size={16}/> Registrar Cliente</button>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-6 rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto text-gray-900 dark:text-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-500 dark:text-gray-400">Uso de CFDI</label>
                  <select value={editarClienteModal.cliente?.uso_cfdi || ''} className="w-full mt-1 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-2.5 rounded-lg text-sm text-gray-900 dark:text-white" onChange={e => setEditarClienteModal({open: true, cliente: {...editarClienteModal.cliente, uso_cfdi: e.target.value}})}>
              ...
              <div className="flex gap-3 pt-6 mt-6 border-t border-gray-200 dark:border-gray-800">
                <button onClick={() => setEditarClienteModal({ open: false, cliente: null })} className="flex-1 py-2.5 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Cancelar</button>
                <button onClick={modificarClienteFiscal} className="flex-1 py-2.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2"><Save size={16}/> Guardar Cambios</button>
              </div>
            </div>
          </div>
        )}
